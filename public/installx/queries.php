...
$sql_queries = [
    ...
    // Tabel berita - dibuat setelah tabel users agar foreign key bisa dibuat
    ...
    "ALTER TABLE `berita` ADD CONSTRAINT `berita_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;",
