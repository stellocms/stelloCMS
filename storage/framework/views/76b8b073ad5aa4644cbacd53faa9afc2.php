                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('themes.install', ['type' => 'frontend', 'name' => $theme->name])); ?>" class="btn btn-sm btn-outline-info">Install</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('themes.install', ['type' => 'admin', 'name' => $theme->name])); ?>" class="btn btn-sm btn-outline-info">Install</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
