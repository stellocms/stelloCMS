...
<div class="container mt-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(in_array('contohplugin.frontpage.index', array_keys(app('router')->getRoutes()->getRoutesByName())) ? route('contohplugin.frontpage.index') : url('/contohplugin')); ?>">Contoh Plugin</a></li>
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="mt-4">
                <a href="<?php echo e(in_array('contohplugin.frontpage.index', array_keys(app('router')->getRoutes()->getRoutesByName())) ? route('contohplugin.frontpage.index') : url('/contohplugin')); ?>" class="btn btn-secondary">
