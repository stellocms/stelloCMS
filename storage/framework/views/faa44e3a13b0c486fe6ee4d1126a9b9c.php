      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo e(url('/panel/dashboard')); ?>" class="nav-link active">
          ...
          <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if(empty($menu->roles) || (auth()->user() && auth()->user()->role && in_array(auth()->user()->role->name, $menu->roles))): ?>
                  ...
                  <li class="nav-item">
                      <?php if($menu->route): ?>
                          <a href="<?php echo e(route($menu->route)); ?>" class="nav-link">
                      <?php else: ?>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('themes.index')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tema</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('plugins.index')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Plugin</p>
                </a>
              </li>
