...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                        ...
                                        <option value="frontend" <?php echo e(old('type') == 'frontend' ? 'selected' : ''); ?>>Frontend</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $allRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="role_<?php echo e(strtolower($role->name)); ?>" name="roles[]" value="<?php echo e($role->name); ?>" <?php echo e(in_array($role->name, $currentRoles) ? 'checked' : ''); ?>>
