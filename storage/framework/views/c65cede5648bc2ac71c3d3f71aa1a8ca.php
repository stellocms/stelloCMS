...
<?php echo e($berita->judul . ' - ' . cms_name()); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('description'); ?>
<?php echo e(Str::limit(strip_tags($berita->isi), 160)); ?>
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(array_key_exists('home', app('router')->getRoutes()->getRoutesByName()) ? route('home') : url('/')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-white">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(array_key_exists('berita.index', app('router')->getRoutes()->getRoutesByName()) ? route('berita.index') : url('/berita')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-indigo-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Berita</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400"><?php echo e(Str::limit($berita->judul, 20)); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="p-6 md:p-8">
                        <div class="flex flex-wrap items-center text-sm text-gray-500 dark:text-gray-400 mb-4">
                            <div class="flex items-center mr-6">
                                ...
                                <span><?php echo e($berita->tanggal_publikasi ? $berita->tanggal_publikasi->format('d M Y') : '-'); ?></span>
                            </div>
                            ...
                            <div class="flex items-center mr-6">
                                ...
                                <span><?php echo e($berita->user->name ?? 'Admin'); ?></span>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <span><?php echo e($berita->viewer ?? 0); ?> dilihat</span>
                            </div>
                        </div>
            ...
            <div class="lg:w-1/3">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 dark:text-white"><?php echo e($berita->tanggal_publikasi->format('d F Y')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 dark:text-white"><?php echo e($berita->user->name ?? 'Admin'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php echo e($berita->aktif ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'); ?>">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 dark:text-white"><?php echo e($berita->viewer ?? 0); ?> kali</p>
                            </div>
                        </div>
                        
                        <?php if($berita->meta_keywords): ?>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex flex-wrap gap-1">
                                    <?php $__currentLoopData = explode(',', $berita->meta_keywords); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo e(route('berita.show', $related->slug)); ?>" class="block group">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <?php echo e($related->tanggal_publikasi->format('d M Y')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.frontend.' . config('themes.frontend') . '::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\htdocs\stelloCMS\app\Themes\frontend\standard\berita\frontend\show.blade.php ENDPATH**/ ?>