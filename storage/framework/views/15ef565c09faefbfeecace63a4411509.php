<?php $__env->startSection('title', 'Edit Pengguna - Manajemen Pengguna - ' . cms_name()); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Pengguna: <?php echo e($user->name); ?></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" 
                                              id="address" name="address" rows="4"><?php echo e(old('address', $user->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $user->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('theme.admin.adminlte::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\htdocs\stelloCMS\app\Themes/admin/adminlte/users/edit.blade.php ENDPATH**/ ?>