<?php $__env->startSection('title', 'Tambah Kategori - ' . cms_name()); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form action="<?php echo e(in_array('panel.kategori.store', array_keys(app('router')->getRoutes()->getRoutesByName())) ? route('panel.kategori.store') : url('/panel/kategori')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" id="warna" name="warna" value="<?php echo e(old('warna', '#007bff')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="ikon" name="ikon" value="<?php echo e(old('ikon', 'fas fa-tag')); ?>" placeholder="e.g. fas fa-tag, far fa-bookmark, etc.">
...
<?php echo $__env->make('theme.admin.' . config('themes.admin') . '::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\htdocs\stelloCMS\app\Plugins\Kategori\Views\create.blade.php ENDPATH**/ ?>