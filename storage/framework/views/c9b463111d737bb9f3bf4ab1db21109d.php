...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_admin" name="roles[]" value="admin" <?php echo e(in_array('admin', $selectedRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="role_admin">Admin</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kepala_desa" name="roles[]" value="kepala-desa" <?php echo e(in_array('kepala-desa', $selectedRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="role_kepala_desa">Kepala Desa</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_sekdes" name="roles[]" value="sekdes" <?php echo e(in_array('sekdes', $selectedRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="role_sekdes">Sekdes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kaur" name="roles[]" value="kaur" <?php echo e(in_array('kaur', $selectedRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="role_kaur">Kaur</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kadus" name="roles[]" value="kadus" <?php echo e(in_array('kadus', $selectedRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="role_kadus">Kadus</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_rw" name="roles[]" value="rw" <?php echo e(in_array('rw', $selectedRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="role_rw">RW</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_rt" name="roles[]" value="rt" <?php echo e(in_array('rt', $selectedRoles) ? 'checked' : ''); ?>>
