<?php $__env->startSection('title', 'Therapy - Physical Therapy Home'); ?>

<?php $__env->startSection('hero'); ?>
<!-- Carousel Start -->
<div class="header-carousel owl-carousel">
    <div class="header-carousel-item">
        <img src="<?php echo e(asset('themes/therapy/img/carousel-1.jpg')); ?>" class="img-fluid w-100" alt="Image">
        <div class="carousel-caption">
            <div class="carousel-caption-content p-3">
                ...
                <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="<?php echo e(url('/appointment')); ?>">Book Appointment</a>
            </div>
        </div>
    </div>
    <div class="header-carousel-item">
        <img src="<?php echo e(asset('themes/therapy/img/carousel-2.jpg')); ?>" class="img-fluid w-100" alt="Image">
        <div class="carousel-caption">
            <div class="carousel-caption-content p-3">
                <h5 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Physiotherapy Center</h5>
                <h1 class="display-1 text-capitalize text-white mb-4">Best Solution For Painful Life</h1>
    ...
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item rounded">
                   <div class="service-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/service-1.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                   </div>
                    <div class="service-content rounded-bottom bg-light p-4">
                        <div class="service-content-inner">
                            ...
                            <a href="<?php echo e(url('/services')); ?>" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item rounded">
                   <div class="service-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/service-2.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                   </div>
                    <div class="service-content rounded-bottom bg-light p-4">
                        <div class="service-content-inner">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item rounded">
                   <div class="service-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/service-3.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                   </div>
                    <div class="service-content rounded-bottom bg-light p-4">
                        <div class="service-content-inner">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item rounded">
                   <div class="service-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/service-4.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                   </div>
                    <div class="service-content rounded-bottom bg-light p-4">
                        <div class="service-content-inner">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-img rounded">
                    <img src="<?php echo e(asset('themes/therapy/img/about-1.jpg')); ?>" class="img-fluid rounded w-100" alt="">
                </div>
            </div>
            <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                ...
                <a href="<?php echo e(url('/about')); ?>" class="btn btn-primary rounded-pill text-white py-3 px-5">Discover More</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="feature-item">
                            <div class="feature-img">
                                <img src="<?php echo e(asset('themes/therapy/img/feature-1.jpg')); ?>" class="img-fluid w-100 rounded" alt="">
                            ...
                            <div class="feature-content p-4">
                                ...
                                <a href="<?php echo e(url('/services')); ?>" class="btn btn-primary rounded-pill text-white py-2 px-4">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="feature-item">
                            <div class="feature-img">
                                <img src="<?php echo e(asset('themes/therapy/img/feature-2.jpg')); ?>" class="img-fluid w-100 rounded" alt="">
                                <div class="feature-icon p-3">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="feature-item bg-primary rounded">
                    <div class="feature-img">
                        <img src="<?php echo e(asset('themes/therapy/img/feature-3.jpg')); ?>" class="img-fluid w-100 rounded" alt="">
                        <div class="feature-icon p-3">
                    ...
                    <div class="feature-content p-4">
                        ...
                        <a href="<?php echo e(url('/team')); ?>" class="btn btn-light rounded-pill text-white py-2 px-4">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="feature-item">
                            <div class="feature-img">
                                <img src="<?php echo e(asset('themes/therapy/img/feature-4.jpg')); ?>" class="img-fluid w-100 rounded" alt="">
                                <div class="feature-icon p-3">
                    ...
                    <div class="col-12">
                        <div class="feature-item">
                            <div class="feature-img">
                                <img src="<?php echo e(asset('themes/therapy/img/feature-5.jpg')); ?>" class="img-fluid w-100 rounded" alt="">
                                <div class="feature-icon p-3">
    ...
    <div class="container py-5">
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item rounded">
                    <div class="team-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/team-1.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                    </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item rounded">
                    <div class="team-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/team-2.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                    </div>
                    <div class="team-text rounded-bottom bg-light p-4">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item rounded">
                    <div class="team-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/team-3.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                    </div>
                    <div class="team-text rounded-bottom bg-light p-4">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item rounded">
                    <div class="team-img rounded-top">
                        <img src="<?php echo e(asset('themes/therapy/img/team-4.jpg')); ?>" class="img-fluid rounded-top w-100" alt="">
                    </div>
                    <div class="team-text rounded-bottom bg-light p-4">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
            <div class="testimonial-item">
                <div class="testimonial-img mb-3">
                    <img src="<?php echo e(asset('themes/therapy/img/testimonial-img.jpg')); ?>" class="img-fluid rounded w-100" alt="">
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.frontend.therapy::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\htdocs\stelloCMS\app\Themes\frontend\therapy\home\index.blade.php ENDPATH**/ ?>