        ...
        <div class="flex flex-col lg:flex-row items-center">
            <div class="lg:w-1/2 mb-12 lg:mb-0">
                ...
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="<?php echo e(route('panel.dashboard')); ?>" class="btn-gradient text-white font-semibold py-3 px-8 rounded-lg text-center">
                        Dashboard
                    </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 card-hover hover:shadow-lg transition-all">
                <div class="flex items-start mb-4">
                    ...
                    <h3 class="text-lg font-bold"><?php echo e($widget->name); ?></h3>
                </div>
                
                <?php if($widget->type === 'html'): ?>
                    <div class="text-gray-700 dark:text-gray-300"><?php echo $widget->content; ?></div>
...
<section class="py-20 gradient-bg">
    <div class="container mx-auto px-4 text-center">
        ...
        <a href="<?php echo e(route('panel.dashboard')); ?>" class="inline-block bg-white text-indigo-600 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors duration-300">
            Akses Dashboard
        </a>
    </div>
</section>
