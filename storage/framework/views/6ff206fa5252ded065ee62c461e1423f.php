...
unset($__errorArgs, $__bag); ?>" id="isi" name="isi" rows="10" required><?php echo e(old('isi')); ?></textarea>
                            <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('berita.index')); ?>" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
        </div>
