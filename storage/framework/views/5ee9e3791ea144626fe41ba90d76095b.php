...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title><?php echo $__env->yieldContent('title', 'Stocker - Stock Market Website'); ?></title>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('themes/stocker/lib/animate/animate.min.css')); ?>">
        <link href="<?php echo e(asset('themes/stocker/lib/lightbox/css/lightbox.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('themes/stocker/lib/owlcarousel/assets/owl.carousel.min.css')); ?>" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="<?php echo e(asset('themes/stocker/css/bootstrap.min.css')); ?>" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="<?php echo e(asset('themes/stocker/css/style.css')); ?>" rel="stylesheet">
    </head>
    ...
    <body>
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="<?php echo e(url('/')); ?>" class="navbar-brand p-0">
                    <h1 class="text-primary"><i class="fas fa-search-dollar me-3"></i><?php echo e(config('cms.name', 'Stocker')); ?></h1>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <div class="footer-item">
                            <a href="<?php echo e(url('/')); ?>" class="p-0">
                                <h4 class="text-white"><i class="fas fa-search-dollar me-3"></i><?php echo e(config('cms.name', 'Stocker')); ?></h4>
                                <!-- <img src="img/logo.png" alt="Logo"> -->
                            </a>
        ...
        <script src="<?php echo e(asset('themes/stocker/lib/wow/wow.min.js')); ?>"></script>
        <script src="<?php echo e(asset('themes/stocker/lib/easing/easing.min.js')); ?>"></script>
        <script src="<?php echo e(asset('themes/stocker/lib/waypoints/waypoints.min.js')); ?>"></script>
        <script src="<?php echo e(asset('themes/stocker/lib/counterup/counterup.min.js')); ?>"></script>
        <script src="<?php echo e(asset('themes/stocker/lib/lightbox/js/lightbox.min.js')); ?>"></script>
        <script src="<?php echo e(asset('themes/stocker/lib/owlcarousel/owl.carousel.min.js')); ?>"></script>
        

        <!-- Template Javascript -->
        <script src="<?php echo e(asset('themes/stocker/js/main.js')); ?>"></script>
    </body>

</html><?php /**PATH D:\htdocs\stelloCMS\app\Themes\frontend\stocker\layouts\app.blade.php ENDPATH**/ ?>