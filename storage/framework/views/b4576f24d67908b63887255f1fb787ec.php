        ...
        <div class="card-body p-0">
            ...
            <div class="relative overflow-hidden rounded-lg" style="height: 300px;">
                ...
                <div class="slider-container flex">
                    <?php $__currentLoopData = $randomNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="slide w-full flex-shrink-0 relative" style="display: <?php if($index == 0): ?> block <?php else: ?> none <?php endif; ?>;">
                        <?php if($news->gambar): ?>
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 text-white">
                            <a href="<?php echo e(route('panel.berita.show', $news->id)); ?>" class="text-decoration-none text-white">
                                <h5 class="font-bold text-lg mb-1"><?php echo e(Str::limit(strip_tags($news->judul), 60)); ?></h5>
                                <small><?php echo e($news->tanggal_publikasi->format('d M Y')); ?></small>
                            </a>
                        </div>
                    </div>
                ...
                <div class="absolute bottom-3 left-0 right-0 flex justify-center space-x-2">
                    <?php $__currentLoopData = $randomNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="indicator w-3 h-3 rounded-full bg-white/50 hover:bg-white transition-colors duration-200 <?php if($index == 0): ?> bg-white <?php endif; ?>" 
...
<?php endif; ?><?php /**PATH D:\htdocs\stelloCMS\app\Plugins/Berita/Views/widget/slider-news.blade.php ENDPATH**/ ?>