...
- Interaktivitas yang ringan dengan Alpine.js
- Ikon dari Heroicons untuk tampilan yang bersih
- Tabs untuk mengelompokkan widget berdasarkan posisi (header, sidebar-kiri, sidebar-kanan, footer, home)
...
### Struktur Tema Standar
- `theme.json` - Metadata tema
- `layouts/app.blade.php` - Layout utama tema
- `home/index.blade.php` - Halaman utama dengan struktur widget
- `css/style.css` - File CSS khusus (jika diperlukan)
- `js/script.js` - File JavaScript khusus (jika diperlukan)

### Instalasi Tema Standar
1. Tema Standar secara otomatis terdaftar saat sistem diinstal
2. Aktifkan tema melalui **Pengaturan** → **Tema**
3. Pilih tema Standar dan klik **Jadikan Default**
4. Tema akan mulai digunakan untuk tampilan frontend

### Penggunaan Widget di Tema Standar
Tema Standar mendukung semua jenis widget dengan tampilan yang optimal:
- Widget plugin ditampilkan dengan format card yang interaktif
- Widget teks dan HTML ditampilkan dengan styling yang konsisten
- Widget diurutkan secara otomatis berdasarkan kolom 'order' di database
