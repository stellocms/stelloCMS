# Dokumentasi Konfigurasi Sistem stelloCMS

## Gambaran Umum

Dokumen ini menjelaskan konfigurasi sistem stelloCMS secara menyeluruh, termasuk konfigurasi aplikasi, database, tema, plugin, dan berbagai aspek lainnya dari sistem.

## Konfigurasi Aplikasi

### File Konfigurasi Utama (.env)
```env
# Aplikasi
APP_NAME=stelloCMS
APP_ENV=local
...
APP_DEBUG=true
APP_TIMEZONE=UTC
APP_URL=http://localhost/simpede/public
...
### Konfigurasi Aplikasi (config/app.php)
```php
<?php
...
### Konfigurasi Tema (config/themes.php)
```php
<?php
...
### Konfigurasi Plugin (config/plugins.php)
```php
<?php
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls the path where plugins are stored.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls the path where plugin migrations are stored.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls the path where plugin seeders are stored.
    |
    */
...
### Konfigurasi CMS (config/cms.php)
```php
<?php
...
### Konfigurasi Cache (config/cache.php)
```php
<?php
...
### Konfigurasi Session (config/session.php)
```php
<?php
...
### Konfigurasi Mail (config/mail.php)
```php
<?php
...
### Konfigurasi Filesystem (config/filesystems.php)
```php
<?php
...
### Konfigurasi Logging (config/logging.php)
```php
<?php
...
### Konfigurasi Services (config/services.php)
```php
<?php
...
### Konfigurasi View (config/view.php)
```php
<?php
...
Dengan dokumentasi konfigurasi sistem yang komprehensif ini, pengguna dan pengembang dapat dengan mudah memahami dan mengelola berbagai aspek konfigurasi stelloCMS. Konfigurasi telah dioptimalkan untuk:

1. **Keamanan**: Konfigurasi default yang aman dengan enkripsi dan protection yang tepat
2. **Performa**: Penggunaan database untuk session, cache, dan queue untuk performa yang lebih baik
3. **Fleksibilitas**: Konfigurasi yang dapat disesuaikan melalui file .env
