                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_admin" name="roles[]" value="admin" {{ in_array('admin', old('roles', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_admin">Admin</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kepala_desa" name="roles[]" value="kepala-desa" {{ in_array('kepala-desa', old('roles', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_kepala_desa">Kepala Desa</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_sekdes" name="roles[]" value="sekdes" {{ in_array('sekdes', old('roles', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_sekdes">Sekdes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kaur" name="roles[]" value="kaur" {{ in_array('kaur', old('roles', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_kaur">Kaur</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kadus" name="roles[]" value="kadus" {{ in_array('kadus', old('roles', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_kadus">Kadus</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_rw" name="roles[]" value="rw" {{ in_array('rw', old('roles', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_rw">RW</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_rt" name="roles[]" value="rt" {{ in_array('rt', old('roles', [])) ? 'checked' : '' }}>
