                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" id="type" name="type" required>
                                        <option value="admin" {{ old('type', $menu->type) == 'admin' ? 'selected' : '' }}>Admin</option>
                                        <option value="frontend" {{ old('type', $menu->type) == 'frontend' ? 'selected' : '' }}>Frontend</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('position') is-invalid @enderror" id="position" name="position" required>
                                        ...
                                        <option value="sidebar-left" {{ old('position', $menu->position) == 'sidebar-left' ? 'selected' : '' }}>Sidebar Kiri</option>
                                        <option value="sidebar-right" {{ old('position', $menu->position) == 'sidebar-right' ? 'selected' : '' }}>Sidebar Kanan</option>
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach($allRoles as $role)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="role_{{ strtolower($role->name) }}" name="roles[]" value="{{ $role->name }}" {{ in_array($role->name, $selectedRoles) ? 'checked' : '' }}>
