...
@section('title', 'Edit Menu - Manajemen Menu - ' . cms_name())
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Menu: {{ $menu->title }}</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('route') is-invalid @enderror" 
                                           id="route" name="route" value="{{ old('route', $menu->route) }}" placeholder="Contoh: berita.index">
                                    @error('route')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('url') is-invalid @enderror" 
                                           id="url" name="url" value="{{ old('url', $menu->url) }}" placeholder="Contoh: https://example.com">
                                    @error('url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Gunakan salah satu dari route atau URL</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                               id="icon" name="icon" value="{{ old('icon', $menu->icon) }}" placeholder="Contoh: fas fa-home">
                                    ...
                                    <div id="iconPreview" style="margin-top: 5px;">
                                        @if(old('icon', $menu->icon))
                                            <i class="{{ old('icon', $menu->icon) }}" style="font-size: 20px;"></i> Icon saat ini
                                        @endif
                                    </div>
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('plugin_name') is-invalid @enderror" 
                                           id="plugin_name" name="plugin_name" value="{{ old('plugin_name', $menu->plugin_name) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_admin" name="roles[]" value="admin" {{ in_array('admin', $selectedRoles) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_admin">Admin</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kepala_desa" name="roles[]" value="kepala-desa" {{ in_array('kepala-desa', $selectedRoles) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_kepala_desa">Kepala Desa</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_sekdes" name="roles[]" value="sekdes" {{ in_array('sekdes', $selectedRoles) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_sekdes">Sekdes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kaur" name="roles[]" value="kaur" {{ in_array('kaur', $selectedRoles) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_kaur">Kaur</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_kadus" name="roles[]" value="kadus" {{ in_array('kadus', $selectedRoles) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_kadus">Kadus</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_rw" name="roles[]" value="rw" {{ in_array('rw', $selectedRoles) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="role_rw">RW</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="role_rt" name="roles[]" value="rt" {{ in_array('rt', $selectedRoles) ? 'checked' : '' }}>
