...
@section('title', 'Pembaruan Sistem - ' . cms_name())
@section('page_title', 'Pembaruan Sistem')
                        ...
                        <div class="col-md-6">
                            <div class="info-box mb-4">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ config('app.version') }}</span>
                                </div>
                            </div>
                        </div>
