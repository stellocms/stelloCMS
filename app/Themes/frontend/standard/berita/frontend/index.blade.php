...
@section('description')
{{ 'Halaman publik untuk berita dan informasi' }}
@endsection
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 card-hover border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <a href="{{ array_key_exists('berita.show', app('router')->getRoutes()->getRoutesByName()) ? route('berita.show', $item->slug) : url('/berita/' . $item->slug) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Baca Selengkapnya
                            ...
                            <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <span>{{ $item->viewer ?? 0 }} dilihat</span>
                            </div>
                        </div>
                    </div>
                </div>
